...
public class Main {
    ...
    //method displayMenu to choose options
    ...
    public static boolean performAction(ServiceCenter serviceCenter, int _option, Scanner inputScan){
        ...
        switch(_option){
            ...
            case 3:
                ...
                serviceCenter.assignAmbulanceForPatientById(patientId);
                waitInput(inputScan);
                break;  
            case 4:
            		clearScreen();
                printSubHeader("Check Position By Id");
                String toFindId= getInput(inputScan, "Please enter the ID which you want to search: ");
                serviceCenter.checkPositionById(toFindId);
                waitInput(inputScan);
                break; 
            case 5:
            		clearScreen();
