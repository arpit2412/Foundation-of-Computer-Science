    ...
    public static boolean performAction(ServiceCenter serviceCenter, int _option, Scanner inputScan){
        ...
        switch(_option){
            case 1:
                ...
                a = Integer.parseInt(triageLevel);
                if(a>6){
                    System.out.println("\nOnly 1-5 accepted Renter the triage level!!\n");
                    accept = true;
                }else{
                    accept = false;
                }
            ...
            case 3:
                ...
                serviceCenter.assignAmbulanceForPatientById(pId);
                waitInput(inputScan);
                break;
            case 4:
                clearScreen();
                printSubHeader("Check Position By Id");
                String findId= getInput(inputScan, "Please enter the ID which you want to search: ");
                serviceCenter.checkPositionById(findId);
                waitInput(inputScan);
                break;
            case 5:
                clearScreen();
